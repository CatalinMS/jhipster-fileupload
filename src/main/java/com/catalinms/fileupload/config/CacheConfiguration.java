package com.catalinms.fileupload.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.catalinms.fileupload.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.catalinms.fileupload.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
